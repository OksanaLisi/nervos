...
const MainPage = () => {
    ...
    const getTodo = useCallback(async () => {
        try {
            const response = await axios.get('https://pcc-app-a416f3e65154.herokuapp.com/api/todo', {
                headers: {
    ...
    const createTodo = useCallback(async () => {
        ...
        try {
            const response = await axios.post('https://pcc-app-a416f3e65154.herokuapp.com/api/todo/add', { text, userId }, {
    ...
    const confirmDelete = async (id) => {
        try {
            await axios.delete(`https://pcc-app-a416f3e65154.herokuapp.com/api/todo/delete/${id}`, {
                headers: { 'Content-Type': 'application/json' }
            });
